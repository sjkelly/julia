...
function _index(s::Array, t::Array, i)
    n = length(t)
    m = length(s)
...
index(s::Union(Array{Uint8,1},Array{Int8,1}),t::Union(Array{Uint8,1},Array{Int8,1}),i) = _index(s,t,i)
index(s::String, t::String, i::Integer) = _index(s,t,i)
index(s::String, t::String) = index(s,t,start(s))


function index(s::ByteString, t::ByteString)
    if length(t) == 1
        search(s, t[1])
    else
        index(s.data, t.data, 1)
    end
end


function index(s::ByteString, t::ByteString, i::Integer)
    if length(t) == 1
        search(s, t[1], i)
    else
        index(s.data, t.data, i)
    end
end
...
function search(s::Union(Array{Uint8,1},Array{Int8,1}),t::Union(Array{Uint8,1},Array{Int8,1}),i)
    ...
    if isempty(t)
        ...
        idx:(idx > 0 ? idx + next(t, endof(t))[2] - 2 : -1)
    end
end
...
function _rindex(s::Array, t::Array, k)
    n = length(t)
    m = length(s)
...
rindex(s::Union(Array{Uint8,1},Array{Int8,1}),t::Union(Array{Uint8,1},Array{Int8,1}),i) = _rindex(s,t,i)
rindex(s::String, t::String, i::Integer) = _rindex(s,t,i)
rindex(s::String, t::String) = (isempty(s) && isempty(t)) ? 1 : rindex(s,t,endof(s))


function rindex(s::ByteString, t::ByteString)
    if length(t) == 1
        rsearch(s, t[1])
    else
        rindex(s.data, t.data, length(s.data))
    end
end


function rindex(s::ByteString, t::ByteString, i::Integer)
    if length(t) == 1
        rsearch(s, t[1], i)
    else
        rindex(s.data, t.data, i)
    end
end
